    ...
    return (
        <div className="container">
            ...
            <div className="grid">
                <div>
                    {matches.length === 0 && (
                        <div className="small">Aucun match aujourd'hui ou chargement...</div>
                    )}
                    {matches.map((m) => (
                        <MatchCard
                            key={m.id}
                            match={m}
                            onPick={togglePick}
                            selected={selections.find((s) => s.matchId === m.id)?.pick}
                        />
                    ))}
                </div>
                <div>
                    <div className="card">
                        ...
                        <div style={{ marginTop: 12 }}>
                            <button
                                className="button"
                                disabled={sending || !bettorName || !stake || selections.length === 0}
